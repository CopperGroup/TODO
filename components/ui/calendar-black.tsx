...
function Calendar({
  ...
  return (
    <DayPicker
      ...
      className={cn("p-3 bg-neutral-900 text-white rounded-lg shadow-lg", className)}
      classNames={{
        ...
        nav_button: cn(
          ...
          "h-7 w-7 bg-neutral-800 p-0 opacity-50 hover:opacity-100 border-gray-600 text-white hover:bg-neutral-700"
        ),
        ...
        day_selected:
          "coppergroup-gradient text-white hover:bg-red-700 focus:bg-red-700",
